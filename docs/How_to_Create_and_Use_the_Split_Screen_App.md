...
Source: https://support.optisigns.com/hc/en-us/articles/360026559573-How-to-Create-and-Use-the-Split-Screen-App
...
![](/hc/article_attachments/360041995893)

## Steps to Create & Use the Split Screen App

### 1. Creating a Split Screen App

![](/hc/article_attachments/30984907809555)
...
![chrome_fXoMvJjziP.png](/hc/article_attachments/30984941338003)
...
![](/hc/article_attachments/30984941345555)
...
![chrome_IrQqLbhNk0.gif](/hc/article_attachments/30984907828115)

* **Scrolling Strip Integration**: Split Screen can be accompanied by a Scrolling Strip. Apps like Weather, News, Social Media walls, and Stock automatically switch to a scrolling strip format when placed in a scrolling strip-like zone. Learn more about creating a Scrolling Strip [**here.**](/hc/en-us/articles/360026559613)

### 5. Making Adjustments (Optional)

After integrating your content, you can make adjustments by hitting the **Settings** wheel:

![](/hc/article_attachments/48817391393683)

This will open the **Split Screen Configs** menu:

![](/hc/article_attachments/48817391398163)
...
![](/hc/article_attachments/30984907837459)
...
1. **Resize the Designer Asset:**
   ...
   * For example: in the below screenshot, the Main Zone is 1920x970. So you'll want to resize your Designer asset to match that number.
   ...
   ![](/hc/article_attachments/37700048880275)
2. **Adjust the Main Zone Ratio:**
   ...
   * This works best with scrolling strips
   ...
   ![](/hc/article_attachments/37700029022099)
3. **Use the Stretch Option:**
   ...
   * This will stretch the content to fill the Main Zone.
   ...
   ![](/hc/article_attachments/37700048887059)

You can get an idea of what these settings will look like with this image:

![](/hc/article_attachments/37700048889875)
...
![](/hc/article_attachments/45708705963667)
