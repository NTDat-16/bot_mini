...
![firefox_XB97JstVsl.jpg](/hc/article_attachments/40326717835539)

3 Screens:

![firefox_37YV6N0Ewz.jpg](/hc/article_attachments/40326717836691)

4 Screens:

![firefox_w0qXk6trkk.jpg](/hc/article_attachments/40326717837715)
...
![subscription plan tab location in optisigns web browser](/hc/article_attachments/33382537873043)

Once there, scroll down to the **Video Wall Add-on** section and choose **Add Screen:**

![video wall add-on section in subscription plan tab with arrow pointing toward Add Screen button](/hc/article_attachments/33382521775379)
...
![screens tab in optisigns with arrow pointing toward Edit Screen button](/hc/article_attachments/33382521787283)

![edit screen menu in optisigns web browser with arrow pointing toward Advanced button](/hc/article_attachments/33382521789203)

Navigate to **Advanced → More**, then find the **Video Wall** option and hit **Activate**:

![edit screen menu in optisigns scrolled down with arrow pointing at More button and another arrow pointed at Video Wall activate button](/hc/article_attachments/33382537889939)
...
**![picture of several app options within optisigns web browser with arrow pointing at Video Wall app](/hc/article_attachments/33382537891219)**

You’ll be prompted to select the number of screens and their orientation:

![](/hc/article_attachments/40326717838739)
...
![open video wall app with zone options on left and screen layout on right](/hc/article_attachments/33382521810835)
...
![picture of video wall configs menu with audio zone and primary zone options](/hc/article_attachments/33382521817235)
...
![example of a multi-zone video wall, 2x1](/hc/article_attachments/33382521820819)
...
![image of 3x1 video wall with arrow pointing at merge screens button](/hc/article_attachments/33382537910675)

Then, select the screens you’d like to merge:

![image with two of three screens selected and an arrow pointing toward merge option](/hc/article_attachments/33382537912083)

These two screens will now be merged, and considered the same Zone:

![image of one larger screen next to a smaller screen to represent two merged zones](/hc/article_attachments/33382521823891)
...
![optisigns three screen video wall displaying mountains and a lake](/hc/article_attachments/33501752188563)
...
![image showing arrow pointing toward unmerge screen option](/hc/article_attachments/33382521829907)
...
![](/hc/article_attachments/47300715383699)

**For Landscape:**

Append ":L" to the end of the resolution string:

![](/hc/article_attachments/47300715387027)
...
![4 screen video wall diagram](/hc/article_attachments/40772872682259)
...
![video wall hdmi diagram](/hc/article_attachments/36987172953491)
...
![optisigns video wall demo](/hc/article_attachments/40326717839635)
...
![hamburger menu](/hc/article_attachments/40326717840531)

This will open up a list of options. **Disable Fullscreen on Startup:**

![fullscreen on startup option](/hc/article_attachments/40326717841555)

Now, scroll down to the **Override Win Size & Position** option:

![override win size and position option](/hc/article_attachments/40326748430739)

Once selected, you'll see this screen:

![override win size and position menu](/hc/article_attachments/40326717844755)
