...
If you're in Japan, it can be helpful to be alerted of earthquakes so you'll know to be prepared. Our new Japan Earthquake app pulls the latest data from the Japan Meteorological Agency (JMA) and gives you the latest alerts directly to your screens.
...
Enter the details for your Earthquake alerts:
...
* **Display Options**
  + **History Window** - Shows how long the earthquake alert will show in your history.
  ...
  + **Refresh Interval** - How often the Earthquake Alert app will refresh measured in seconds. When used in a playlist, it will refresh each time it is loaded.
...
OptiSigns is a leader in [digital signage software](https://www.optisigns.com/). If you have any additional questions, concerns or any feedback about OptiSigns or getting Earthquake alerts to work on it, feel free to reach out to our support team at [support@optisigns.com](mailto:support@optisigns.com).
