...
Source: https://support.optisigns.com/hc/en-us/articles/360048914673-Edit-Screen-What-does-each-option-do
...
* **Type -** Select what will be bound to the screen
  ...
  + **Playlist**:  Selecting this allows you to [Select a Playlist](/hc/en-us/articles/28295104605843) from the drop-down which will bind the screen to that playlist.
  ...
  + **Schedule**: Selecting this allows you to [Select a Schedule](/hc/en-us/articles/360016981853) from the drop-down and designate a schedule you want the screen to follow.
...
* **Connection Status**
  + [**Show Downloading Status**](/hc/en-us/articles/12947300131731) - Set to show or hide downloading status on your screen
  + [**Show Offline Indicator**](/hc/en-us/articles/12498801963027) - Show an icon on the screen when there's no network connection, this is useful if your screen have live content that need internet connection all the time.
...
* **Advanced Playlist Settings**
  + [**Sync Play**](/hc/en-us/articles/4412065189267) - Synchronize playback timing across your screens.
...
* [**Lock Down**](/hc/en-us/articles/4416681544211) - Hide OptiSigns controls and menu to prevent viewers from making changes to the app. If running Kiosk, viewers still can interact with Kiosk, but cannot use the menu or close app.
* [**Playback Control**](/hc/en-us/articles/4416704273811)- Enable the viewer to navigate forward, backward, and pause the playlist.
* [**Proof of Play**](/hc/en-us/articles/360058936513) - Send playback data to enable proof of play reporting.
* **Brightness** - Controls the brightness of your screen.
* **Volume** - Controls the volume of your screen.
* [**Schedule Power, Volume, Brightness, mute**](/hc/en-us/articles/4416681142675) - Schedule Device, TV power on/off, Volume, Brightness or when device should download new contents. This will largely depend on your devices and TV/Monitor selection.
* **Polling Interval**
...
* [**AI Add-On**](/hc/en-us/articles/360058259834) - Enable OptiSigns AI camera to detect and collect data around passing foot traffic, or responsively display different content depending on the demographic of the viewers in front of your screen.
* [**Sensor Add-On**](/hc/en-us/articles/13097501958291) - Activate OptiSigns IoT Sensor to measure the impact of your signs.
...
[**Operational Schedule**](/hc/en-us/articles/28598173096723)- Schedule TV power on/off times and control volume and brightness.
...
[**Remote Commands**](/hc/en-us/articles/30010338528659) **-** Executes remote commands like rebooting, taking screenshots, adding Wi-Fi, and more.
...
Explore more about executing remote commands on Android by [clicking here](/hc/en-us/articles/30010338528659), and for Windows, [click here.](/hc/en-us/articles/4408658251027)
